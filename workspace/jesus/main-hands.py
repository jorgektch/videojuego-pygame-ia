...
BACKGROUND_IMG = "workspace/jesus/img/fondo.jpg" # Imagen de fondo
...
THINGS_IMG_LIST = ["img/moneda-01.png", "img/moneda-02.png", "img/moneda-03.png"] # Lista de things (se elegiran aleatoriamente)te)
...
class Game:
    ...
    def detect_collisions(self):
        ...
        for thing in thing_hit_list:
            ...
            self.sprite_list.remove(thing) # Se elimina de la lista de sprites (things y player)
            self.score = self.score - 1 # Aumenta el puntaje
            self.play_incorrect_sound() # Se reproduce el sonido de error
    ...
    def display_info(self):
        font = pygame.font.SysFont('OCR-A Extended', 25, bold=False)
        score_text = font.render("Puntos: "+str(self.score)+" / "+str(TOP_SCORE), True, WHITE)
        time_text = font.render("Tiempo: "+str(int(self.time)), True, WHITE)
    ...
    def display_frame(self):
        ...
        if self.game_over == False:
            ...
            text = font.render("Ganaste. Presiona ENTER para continuar", True, WHITE)
            # Posicion del texto
            ...
            text = font.render("Ganaron: "+str(won_count)+" | Perdieron: "+str(lost_count), True, WHITE)
            self.screen.blit(text, [text_x+120, text_y+30])
            ...
            font = pygame.font.SysFont('OCR-A Extended', 30, bold=False)
            text = font.render("Perdiste. Presiona ENTER para continuar", True, WHITE)
            # Posicion del texto
            text_x = SCREEN_WIDTH/2 - text.get_width()/2
            text_y = SCREEN_HEIGHT/2 - text.get_height()/2
            self.screen.blit(text, [text_x, text_y])
