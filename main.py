...
class Juego:
    ...
    def iniciar(self):
        ...
        while self.finalizado == False:
            ...
            self.fuente_informacion = pygame.font.SysFont("Arial", 35, bold=True)
            ...
            self.pantalla.blit(texto_aciertos, (40,150))

            texto_reto = self.fuente_informacion.render("Captura los múltiplos de: "+str(self.jugador.numero), 1, COLOR_BLANCO)
            ...
            self.pantalla.blit(texto_errores, (PANTALLA_ANCHO-40-texto_errores_rect.width,150))
